    ...
    <div className='max-w-screen-2xl mx-auto grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 
                    gap-6 xl:gap-10 px-4'> 
        {
         productData.map((item)=>(
          <div key={item.id} className='bg-white h-auto border-[1px] border-gray-200 py-8 z-3 hover:border-transparent 
            ...
            <div className='px-4 z-10 bg-white'>
              ...
              to-yellow-200 border hover:from-yellow-300 hover:to-yellow-500 border-yellow-500 
